...
Every `ModuleDefinition` defines a property called `CorLibTypeFactory`,
...
Alternatively, a generic instance can also be generated via the
...
Likewise, a `TypeSignature` can also be converted back to a
